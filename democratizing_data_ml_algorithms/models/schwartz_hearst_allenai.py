...
def extract_abbreviation_definition_pairs(nlp, text: str) -> List[str]:
    """
    Extracts the acronym from a string of text.
    """
    doc = nlp(text)
    pairs = dict()
    for abrv in doc._.abbreviations:
        if abrv not in pairs:
            pairs[abrv.text] = abrv._.long_form.text.strip('"').strip("'")
...
if __name__ == "__main__":
    ...
    with open("data/kaggle/validation/7d9c76c33.json", "r") as f:
        ...
        print(extract_abbreviation_definition_pairs(nlp, text))
